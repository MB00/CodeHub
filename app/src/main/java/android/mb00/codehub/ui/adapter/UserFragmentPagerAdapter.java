...
import android.mb00.codehub.ui.UserGistsFragment;
import android.mb00.codehub.ui.UserOverviewFragment;
import android.mb00.codehub.ui.UserPulseFragment;
import android.mb00.codehub.ui.UserReposFragment;
import android.mb00.codehub.ui.UserStarredFragment;
...
public class UserFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    public UserFragmentPagerAdapter(FragmentManager fragmentManager, Context context, Bundle userBundle) {
        ...
        overviewTabTitle = context.getResources().getString(R.string.overview);
        reposTabTitle = context.getResources().getString(R.string.repositories);
        starredTabTitle = context.getResources().getString(R.string.starred);
        gistsTabTitle = context.getResources().getString(R.string.gists);

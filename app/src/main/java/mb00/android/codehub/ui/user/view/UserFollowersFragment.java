...
public class UserFollowersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        userFollowersRecyclerView = userFollowerView.findViewById(R.id.user_followers_recycler_view);
        noFollowersTextView = userFollowerView.findViewById(R.id.no_followers_text_view);
        userFollowersSwipeRefreshLayout = userFollowerView.findViewById(R.id.user_followers_swipe_refresh_layout);

...
/**
 * Fragment containing user repositories; launched from {@link HomeFragmentPagerAdapter}
 */

public class HomeReposFragment extends BaseBindingFragment<FragmentHomeReposBinding, HomeViewModel> {

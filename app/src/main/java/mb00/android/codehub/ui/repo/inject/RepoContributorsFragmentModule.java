...
@Module
public class RepoContributorsFragmentModule {

    @Provides
    RepoContributorsViewModel provideRepoContributorsViewModel(RepoInteractor interactor, RepoRouter router) {
        return new RepoContributorsViewModel(interactor, router);
    }

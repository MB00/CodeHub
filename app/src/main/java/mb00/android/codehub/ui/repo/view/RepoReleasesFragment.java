...
public class RepoReleasesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        repoReleaseRecyclerView = repoReleaseView.findViewById(R.id.repo_release_recycler_view);
        noReleasesTextView = repoReleaseView.findViewById(R.id.no_releases_text_view);
        repoReleasesSwipeRefreshLayout = repoReleaseView.findViewById(R.id.repo_releases_swipe_refresh_layout);
